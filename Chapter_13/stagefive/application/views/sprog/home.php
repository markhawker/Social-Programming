...
<p><?php echo anchor('sprog/profile/'.$username, 'My Profile'); ?> | <?php echo anchor('sprog/latest', 'Latest Updates'); ?> | <?php echo anchor('sprog/logout', 'Logout', array('onclick' => 'google.friendconnect.requestSignOut();')); ?></p>